 ...
 * @Repository
 * 
 * @Transactional public class PatientRepository {
 * 
 * 
 ...
 * c.setProjection(Projections.property("id")); List<Patient> list =
 * (List<Patient>) template.findByCriteria(c); Patient p = null; if
